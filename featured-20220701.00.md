...
Stream water sampling in LEF began in 1983. Weekly water chemistry sampling started in 1988 at 13 sites along the El Verde, Bisley and other streams. All water samples are measured for pH, conductivity, ammonium and nitrate content. A continuous record of stream stage (height) is recorded by a datalogger at all ongoing stream sampling sites, while average daily streamflows are available from USGS at other locations in LEF. Such long-term data are extremely important for the analysis of ecosystem changes over time as well as synthesis research.
</br>
</br>
<p align="center">
...
Below, we summarize several catchment science publications that used the stream data from the LEF mountane tropical forest featured here.
