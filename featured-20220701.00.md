...
Long-term data are extremely important for the analysis of ecosystem changes over time as well as synthesis research.
</br>
...
Stream water sampling in LEF began in 1983. Weekly water chemistry sampling started in 1988 at 13 sites along the El Verde, Bisley and other streams. All water samples are measured for pH, conductivity, NH4 and NO3. A continuous record of stream stage (height) is recorded by a datalogger at all ongoing stream sampling sites, while average daily streamflows are available from the USGS and at other locations in LEF. From 1994 on all analyses were conducted at the University of New Hampshire.
</br>
</br>
<p align="center">
...
Since the founding of the first research station in the Luquillo Mountains in 1940, hundreds of research studies have been carried out encompassing a large variety of topics including how a changing climate and disturbance regimes (e.g. hurricanes, landslides, alterations in agricultural practice) alter hydrological and biogeochemical processes and also highlight the resilience of the ecosystem. Here we list publications and summarize their outcome that are added to the data package landing page.

at this center for ecosystem research. Research papers on catchment science in the montane tropic, using the stream data featured here
